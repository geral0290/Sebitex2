...
public class FrmLogin extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        java.awt.FlowLayout flowLayout1 = new java.awt.FlowLayout(2, 1, 1);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIEW/20180922_010830.png"))); // NOI18N
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        try {
            setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/".concat(this.iconSalida))));
        } catch (Exception ex) {
            setText(alter);
    ...
    public void mouseExited(MouseEvent e) {
        ...
        try {
            setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/".concat(this.iconEntered))));
        } catch (Exception ex) {
            setText(alter);
            System.out.println(ex.getMessage());
        }
