...
public class FrmVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu13.setText("Cliente");

        jMenu24.setText("Nuevo");
        ...
        jMenu28.setText("Editar");
        jMenu13.add(jMenu28);

        jMenu29.setText("Cancelar");
        jMenu13.add(jMenu29);

        jMenu30.setText("Retornar");
        jMenu13.add(jMenu30);

        jMenu11.add(jMenu13);

        jMenu14.setText("Vendedor");
